...
- Database operation: Có các option sau
...
- Database opiton/ Data vault option: 
	- Nếu cài CDB, danh sách các thành phần (components) có thể bật/tắt. Mỗi mục tương ứng với một tính năng của Oracle Database. Các mục phổ biến gồm:
	...
	- Nếu cài PDB có 2 option: 
		- Enable Oracle Database Vault ->	Bật Data Vault trong PDB mới 
		- Disable Oracle Database Vault -> Không bật (mặc định)
...
### 13. Xóa oracle database nếu cần:
```bash
